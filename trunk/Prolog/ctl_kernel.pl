...
all(_,_,L,S):-inl(S,L),
                !.
all(P1,P2,L,S):- conc(P2,S,P02),call(P02),!,
...
and(P1,P2,S):-conc(P1,S,P01),call(P01),
              conc(P2,S,P02),call(P02).

implies(P1,P2,S):-conc(P1,S,P01),call(P01),
                  not(P2,S),!,fail.
implies(_,_,_).

equ(P1,P2,S):-conc(P1,S,P01),call(P01),
              conc(P2,S,P02),call(P02),
              !.
equ(P1,P2,S):-not(P1,S),
              not(P2,S).

conc(P,S,P01):-P=..K,insert(K,[S],P0),P01=..P0.
