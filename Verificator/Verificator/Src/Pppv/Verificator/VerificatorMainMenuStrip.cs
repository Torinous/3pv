...
namespace Pppv.Verificator
{
	...
	public class VerificatorMainMenuStrip : MenuStrip
	{
		...
		private CommandToolStripMenuItem toolStripMenuConstructStateSpace;
		...
		private void InitializeComponent()
		{
			...
			this.toolStripMenuManual  = new CommandToolStripMenuItem(new StartPrologInterfaceCommand());
			this.toolStripMenuConstructStateSpace = new CommandToolStripMenuItem(new ConstructStateSpaceCommand());
			...
			this.toolStripMenuAnalize.DropDownItems.Add(this.toolStripMenuConstructStateSpace);
