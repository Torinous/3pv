...
namespace Pppv.Editor.Commands
{
   ...
   public class DeleteCommandTests
   {
      ...
      public void TestSimpleDeletion()
      {
         ...
         AddNetElementCommand command = new AddNetElementCommand();
         command.Net = graphicalNet;
         command.Element = new Place();
         command.Execute();
         ...
         command2.Element = graphicalNet.FindShapeForElement(graphicalNet.Places[0] as Place);
         command2.Execute();
