...
namespace Pppv.Editor.Commands
{
   ...
   public class MacroCommandTests
   {
      ...
      private static DeleteCommand DeleteCommand(PetriNetGraphical graphicalNet, INetElement element)
      {
         ...
         command.Element = graphicalNet.FindShapeForElement(element);
         return command;
      }

      private static AddNetElementCommand AddNetElementCommandFabric(PetriNetGraphical graphicalNet)
      {
         return new AddNetElementCommand(graphicalNet, new Place());
      }
   }
}
